...
MAP_BOUNDS = {'bottom_left': {'lon': -70, 'lat': -6},
              'top_right': {'lon': 80, 'lat': 2}
              }

MAP_ARGS = {'center': {'longitude': -78, 'latitude': -1},
	    'scale': 23000
	   }
...
YES_WORDS = {"en":["yes","ya","y","yah","yey"],"es":["si","s","SI","S"]}

NO_WORDS = {"en":["no","nope","nah","nay","n"],"es":["no","n","NO","N"]}
